  ...
  return (
    <div className="space-y-6 pb-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-5">
        {/* Dataset A */}
        <div className="bg-white border border-slate-200 rounded-2xl shadow-sm p-5 space-y-3.5 border-cyber-cyan/40 glow-cyan">
        ...
        {/* Dataset B */}
        <div className="bg-white border border-slate-200 rounded-2xl shadow-sm p-5 space-y-3.5 border-purple-500/40">
          <div className="flex items-center justify-between">
