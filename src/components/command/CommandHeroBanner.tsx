...
export const CommandHeroBanner: React.FC<CommandHeroBannerProps> = ({ onNavigate }) => {
  ...
  return (
    <div
      ...
      className="relative bg-white border border-slate-200 p-5 rounded-2xl shadow-md overflow-hidden select-none"
    >
      ...
      <div className="relative z-10 flex flex-col md:flex-row items-start md:items-center justify-between gap-5">
        ...
        <div className="space-y-2 max-w-2xl font-sans">
          ...
          <h1 className="text-xl md:text-2xl font-bold font-sans text-slate-900 tracking-tight leading-tight uppercase">
