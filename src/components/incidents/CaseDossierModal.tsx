        ...
        <div className="px-6 py-4 bg-white border-t border-slate-200 flex flex-wrap items-center justify-between gap-3 flex-shrink-0">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="flex items-center gap-1 px-3 py-2 text-xs font-sans bg-slate-50 hover:bg-slate-100 text-slate-800 border border-slate-200 rounded-2xl transition-all"
            >
